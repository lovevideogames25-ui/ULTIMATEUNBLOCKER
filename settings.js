...
// Theme Color Definitions - Fixed to match HTML values exactly
const themes = {
    purple: {
        primary: '#533483',
        secondary: '#8b5cf6',
        ...
        loadingBg: 'linear-gradient(135deg, #533483 0%, #8b5cf6 25%, #7c3aed 50%, #6d28d9 75%, #533483 100%)',
        navbar: 'rgba(15, 15, 30, 0.95)',
    ...
    blue: {
        ...
        loadingBg: 'linear-gradient(135deg, #1e40af 0%, #3b82f6 25%, #2563eb 50%, #1d4ed8 75%, #1e40af 100%)',
        navbar: 'rgba(30, 58, 138, 0.95)',
        card: 'rgba(255, 255, 255, 0.08)',
        text: '#ffffff'
    },
    green: {
        ...
        loadingBg: 'linear-gradient(135deg, #047857 0%, #10b981 25%, #059669 50%, #047857 75%, #064e3b 100%)',
    ...
    red: {
        ...
        loadingBg: 'linear-gradient(135deg, #b91c1c 0%, #ef4444 25%, #dc2626 50%, #b91c1c 75%, #7f1d1d 100%)',
    ...
    dark: {
        ...
        loadingBg: 'linear-gradient(135deg, #374151 0%, #4b5563 25%, #6b7280 50%, #374151 75%, #111827 100%)',
