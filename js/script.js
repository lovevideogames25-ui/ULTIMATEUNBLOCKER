...
function showSection(sectionId, updateHistory = true) {
    ...
    setTimeout(() => {
        ...
        if (targetSection) {
            console.log('✅ Found target section:', sectionId, 'element:', targetSection);
            targetSection.classList.add('active');
            
            // Special handling for all sections to ensure visibility
            console.log('🎯 Applying forced visibility to section:', sectionId);
            targetSection.style.display = 'flex';
            targetSection.style.visibility = 'visible';
            targetSection.style.opacity = '1';
            targetSection.style.position = 'relative';
            targetSection.style.zIndex = '10';
            targetSection.style.transform = 'translateY(0) !important';
            targetSection.style.top = '0 !important';
            targetSection.style.left = '0 !important';
            targetSection.style.width = '100% !important';
            targetSection.style.height = 'auto !important';
            targetSection.style.minHeight = '100vh !important';
            targetSection.style.overflow = 'visible !important';
            
            // Special handling for links section
            if (sectionId === 'links') {
                console.log('🔗 Special handling for links section');
                targetSection.style.display = 'flex !important';
                targetSection.style.visibility = 'visible !important';
                targetSection.style.opacity = '1 !important';
                targetSection.style.position = 'relative !important';
                targetSection.style.zIndex = '100 !important';
                targetSection.style.height = 'auto !important';
                targetSection.style.minHeight = '100vh !important';
                targetSection.style.overflow = 'visible !important';
                targetSection.style.transform = 'translateY(0) !important';
                ...
                const linkCards = targetSection.querySelectorAll('.link-card');
                ...
                console.log('🔗 Forced links section and cards visibility');
            }
            
            // Special handling for categories section
            if (sectionId === 'categories') {
                console.log('📂 Special handling for categories section');
                // Additional categories-specific handling if needed
            }
            
            // Special handling for categoryDetail section
            if (sectionId === 'categoryDetail') {
                console.log('🔗 Special handling for categoryDetail section');
                
                // Also ensure links container is visible
                const linksContainer = document.getElementById('linksContainer');
                if (linksContainer) {
                    console.log('📱 Making links container visible');
                    linksContainer.style.display = 'grid';
                    linksContainer.style.visibility = 'visible';
                    linksContainer.style.opacity = '1';
                    linksContainer.style.position = 'relative';
                    linksContainer.style.zIndex = '10';
                }
            }
            
            // Update browser URL and history with proper routing
                ...
                try {
                    ...
                    switch(sectionId) {
                        ...
                        case 'settings':
                            ...
                            break;
                        case 'categoryDetail':
                            newUrl = '/category/detail';
                            break;
                        default:
                            newUrl = '/' + sectionId;
                    }
                    
                    window.history.pushState({page: sectionId}, '', newUrl);
                    console.log('🌐 URL updated to:', newUrl);
                } catch (error) {
                    console.log('History API not available, continuing without URL update');
                }
            }
            ...
            if (sectionId === 'home') {
                activeNavLink = document.querySelector(`[href="#${sectionId}"]`);
            } else if (sectionId) {
                activeNavLink = document.querySelector(`[href="#${sectionId}"]`);
            }
...
// Manual links section test
window.showLinksSection = function() {
    console.log('🔗 Manual links section test');
    ...
    // Show links section with different approach
    const linksSection = document.getElementById('links');
    if (linksSection) {
        console.log('🔗 Found links section, showing it');
        console.log('🔗 Links section HTML:', linksSection.outerHTML.substring(0, 200));
        
        // Remove from DOM and re-add to force reflow
        const parent = linksSection.parentNode;
        const nextSibling = linksSection.nextSibling;
        parent.removeChild(linksSection);
        
        // Re-add with forced styles
        parent.insertBefore(linksSection, nextSibling);
        
        // Apply styles after re-adding
        setTimeout(() => {
            linksSection.classList.add('active');
            linksSection.style.display = 'block !important';
            linksSection.style.visibility = 'visible !important';
            linksSection.style.opacity = '1 !important';
            linksSection.style.position = 'absolute !important';
            linksSection.style.top = '80px !important';
            linksSection.style.left = '0 !important';
            linksSection.style.width = '100% !important';
            linksSection.style.height = 'calc(100vh - 80px) !important';
            linksSection.style.zIndex = '1000 !important';
            linksSection.style.background = 'red !important';
            linksSection.style.border = '5px solid yellow !important';
            
            // Make link cards visible
            const linkCards = linksSection.querySelectorAll('.link-card');
            linkCards.forEach((card, index) => {
                card.style.display = 'block !important';
                card.style.visibility = 'visible !important';
                card.style.opacity = '1 !important';
                card.style.background = 'blue !important';
                card.style.border = '2px solid white !important';
                card.style.margin = '10px !important';
                console.log(`🔗 Made link card ${index} visible`);
            });
            
            console.log('🔗 Links section should now be visible with red background');
        }, 100);
